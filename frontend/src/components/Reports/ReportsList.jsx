...
const ReportsList = () => {
  ...
  const reports = [
    ...
    { name: 'Item Wise Profit', path: '/reports/item-wise-profit-report', icon: FileText, color: 'bg-purple-100 text-purple-700' },
    { name: 'Stock Transfer Report', path: '/reports/stock-transfer-report', icon: FileText, color: 'bg-teal-100 text-teal-700' },
    { name: 'Premium Member Sale Report', path: '/reports/customer-sale-report', icon: FileText, color: 'bg-cyan-100 text-cyan-700' },
    { name: 'Sale Items Report', path: '/reports/sale-items-report', icon: FileText, color: 'bg-cyan-100 text-cyan-700' },
    { name: 'Item Stock (Date Wise)', path: '/reports/items-stock-history-report', icon: FileText, color: 'bg-pink-100 text-pink-700' },
    { name: 'Stock Comparison', path: '/reports/item-compare', icon: FileText, color: 'bg-lime-100 text-lime-700' },
    { name: 'Customer Report', path: '/reports/customer', icon: FileText, color: 'bg-gray-100 text-gray-700' },
    { name: 'Seller Point Report', path: '/reports/seller-points', icon: FileText, color: 'bg-amber-100 text-amber-700' },
    { name: 'Club Bill Report', path: '/reports/club-bill', icon: FileText, color: 'bg-emerald-100 text-emerald-700' },
    { name: 'All Transactions', path: '/reports/all-transaction-report', icon: FileText, color: 'bg-slate-100 text-slate-700' },
    { name: 'Expense Report', path: '/reports/expense', icon: FileText, color: 'bg-rose-100 text-rose-700' },
   // { name: 'PartyWise Item Report', path: '/reports/partywise-item-report', icon: FileText, color: 'bg-rose-100 text-rose-700' },
    { name: 'Customer Order Report', path: '/reports/customer-order-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Delivery Charge Report', path: '/reports/delivery-charge-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Delivery Rider Report', path: '/reports/delivery-rider-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'LowStock Report', path: '/reports/lowstock-item-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Item Not Sold Report', path: '/reports/deadstock-item-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Expired Stock Report', path: '/reports/expiredstock-item-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Inventory Turn Over Report', path: '/reports/inventoryturnover-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Sales Trend Report', path: '/reports/salestrend-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Customer Retention Report', path: '/reports/customer-retention-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Category Wise Report', path: '/reports/categorywise-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'ForeCast Report', path: '/reports/forecasting-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Coupon Discount Impact Report', path: '/reports/discount-impact-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Warehouse Utilize Report', path: '/reports/warehouse-utilize-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Sale VS Inventory Report', path: '/reports/sale-inventory-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Season Sale Report', path: '/reports/seasonsale-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Payment Report', path: '/reports/payment-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
    { name: 'Club Report', path: '/club-bill-report', icon: FileText, color: 'bg-indigo-100 text-indigo-700' },
  ];
