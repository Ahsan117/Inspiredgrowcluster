...
const statusOptions = [
  ...
  const filteredOrders = orders.filter((o) => {
    ...
    const vanAssign = o.assignVan || o.assignRider
    return matchesSearch && (matchesStatus || vanAssign);
  });
  ...
  const exportToPDF = () => {
    ...
    doc.save("Orders(Van Assigned).pdf");
  };
      ...
      <div className="flex flex-grow">
        ...
        <main className="flex flex-col flex-grow p-4 overflow-y-auto">
          ...
          <div className="flex flex-col items-start justify-between mb-4 md:flex-row md:items-center">
            <div>
              <h1 className="text-xl font-semibold text-gray-800 md:text-2xl">Orders(Van Assigned)</h1>
