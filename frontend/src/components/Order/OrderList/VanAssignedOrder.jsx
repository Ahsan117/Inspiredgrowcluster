...
const OrderList = () => {
  ...
  const[orderStatus,setOrderStatus]=useState("Van Assigned")
  ...
  { value: "Van Assigned", label: "Van Assigned", icon: "🛵", color: "yellow" },
 ...
 setWarehouses(response.data.data)
  ...
  const matchesStatus =  u.status === "Van Assigned" || u.status=== "Arrived at Location";
        ...
        <div className="flex flex-col w-full p-2 mx-auto overflow-x-auto transition-all duration-300">
          <header className="flex flex-col items-center justify-start px-2 py-2 mb-2 bg-gray-100 rounded-md shadow md:justify-between md:flex-row">
            <div className="flex items-baseline gap-2 sm:text-left">
              <h1 className="text-lg font-semibold">Van Assigned Orders List</h1>
            ...
            <div className="w-full overflow-x-auto overflow-y-visible">
              <div className='min-w-full'>
                ...
                <thead className="w-full bg-gray-200">
                  <tr>
                    {["#","Order ID"," Customer Name","Items","Total","Status","Assigned Van","Action"]
        ...
        >
          <div className="py-1" role="none">
            {/* Edit Action */}
             ...
             { u.status=== "Arrived at Location" && !u.PosCreated  &&(
               <button
              ...
              role="menuitem"
              onClick={() => {
                  navigate(`/order/pos-create?orderId=${u._id}&warehouse=${u.warehouse._id}&customer=${u.customer._id}`);
              }}
            >
