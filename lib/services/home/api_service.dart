...
class ApiService {
  ...
  static const String Base2Url =
      'https://pos.inspiredgrow.in/vps/api/catalog/trending-tiles-with-items?page=1&limit=6';
    ...
    return await _makeRequest('trending_tiles', () async {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          foundation
              .debugPrint('âš ï¸ Trending tiles API error: ${response.statusCode}');
          throw Exception('Failed to load trending tiles');
        }
      } catch (e) {
        foundation.debugPrint('ðŸš¨ Error fetching trending tiles: $e');
        rethrow;
      }
    });
  }
