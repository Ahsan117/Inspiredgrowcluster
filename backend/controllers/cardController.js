...
exports.sendOTP = async (req, res) => {
  try {
    ...
    // Send SMS
    const msg = `Dear Customer, ${otp} is the OTP for your login at Grocery on Wheels. In case you have not requested this, please contact us at contact@inspiredgrow.in – INSPGD`;
    const smsUrl =
